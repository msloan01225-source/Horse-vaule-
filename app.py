...
# Make sure `edgebrain_model.pkl` is in the same directory
...
# ---- FOOTBALL PAGE ----
    ...
    st.info("Mock data – EdgeBrain integration coming soon.")

# ---- EDGEBRAIN PAGE ----
elif selected == "EdgeBrain":
    st.title("🧠 EdgeBrain – Smart Predictions")
    st.write("Proprietary model probabilities across all runners.")
    st.dataframe(
        df[["Horse", "Course", "EdgeBrain Win %", "Risk"]],
...
# ---- HOW IT WORKS PAGE ----
    ...
    - 🧠 Proprietary EdgeBrain ML Model  
    - 🔎 Risk Indicators & Smart Filtering

    This returns a **BetEdge %** and **EdgeBrain %** to guide your stakes.
    """)
    st.video("https://www.youtube.com/watch?v=2Xc9gXyf2G4")  # final intro video
