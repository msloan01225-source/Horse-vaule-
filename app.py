# app.py  — Streamlit UI (front‑end only) that talks to your FastAPI backend
# =============================================================================
# This app does NOT call Betfair directly. It uses your API endpoints:
#   /health /status /config /presets
#   /markets?day=today|tomorrow
#   /races?day=...
#   /race?course=...&time_hhmm=...&day=...
#   /race/top3?course=...&time_hhmm=...&day=...
#   /race/history?course=...&time_hhmm=...&day=...
#   /alerts?day=...
#
